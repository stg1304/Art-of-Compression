...
private:
   ...
   */
   ...
   void render_help(Node* subtree, PNG & out);
   void draw (Node* subtree, PNG & out);
   void prune_helper(double pct, int tol, Node* subtree);
   vector<int> isPrune(int tol, Node* subtree);
   void isPrune_helper(vector<int> & count, int tol, Node* root, Node* subtree);
   void clear_helper(Node* subtree);
   void copy_helper(Node* orgTree, Node* copyTree);
   pair< pair<int, int>, pair<int, int> > getSmall(stats & s, pair<int, int> ul, pair<int, int> lr);
   void test();
   void test_help(Node* subtree, int* count); 
